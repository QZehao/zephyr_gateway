...
{
    if (success_count != NULL) *success_count = g_cloud.success_count;
    if (fail_count != NULL) *fail_count = g_cloud.fail_count;
    if (cached_count != NULL) *cached_count = g_cloud.cached_count;
}
